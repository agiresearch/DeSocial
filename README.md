...
After download it, please slice the edges equally into 40 time periods, in order to process the dataset in our problem setting. Details are shown in Appendix A.1.
